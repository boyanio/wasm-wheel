    ...
    document.addEventListener('wheelPartLoaded', async (e) => {
        ...
        try {
            ...
            if (randomNumber > 0 && randomNumber <= 100) {
                ...
                console.error(`Wheel part ${wheelPart.name} cannot generate random numbers between [1, 100]`);
            }
        } catch (err) {
            console.error(`Wheel part ${wheelPart.name} threw an exception while random number check. ${err}`);
        }
    }, false);
